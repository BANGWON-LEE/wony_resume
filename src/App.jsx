        ...
        <header className="resume_header">
          ...
          <TextGothicA1BigTitle>
            <h1 className="text_gothic_a1_big_title_inner">
              용량 데이터 시각화와 렌더링 최적화 경험을 보유한 프론트엔드
              개발자, 이방원
            </h1>
            {/* <h1 className="text_gothic_a1_big_title_inner">
              프론트엔드 개발자 이방원입니다.
        ...
        <div className="header_my_info resume_intro">
          <div className="header_inner_left">
            <TextBlackHanSansContent>
              대용량 데이터 시각화와 실시간 데이터 처리 경험을 보유한 React ·
              TypeScript 기반 프론트엔드 개발자입니다. <br /> 스마트 팩토리 관제
              시스템에서 MQTT 기반 데이터 스트리밍과 재사용 차트 컴포넌트를
              구축하며 LCP를 21.3초→4.0초(-81%)로 개선했고,
              <br /> 사용자 인터뷰를 통해 업무 기록 시간을 1시간에서 5분으로
              단축했습니다. 또한 지도 기반 서비스 ‘마이플랜’을 개발하며
              <br /> 렌더링 최적화를 통해 TBT 20%, Speed Index 24%를
              개선했습니다.
              {/* </p> */}
