              ...
              <TextBlackHanSansContent>
                <div className="text_box">
                  <ul className="text_box_ul">
                    <li>
                      Chart.js 기반의 재사용 가능한 차트 컴포넌트를 개발. time,
                      value, key, type 등의 props만 전달하면 다양한 데이터를
                      시각화할 수 있도록 구현하여 사용성과 확장성을 높임
                    </li>
                    <li>
                ...
                <div className="text_box">
                  <ul className="text_box_ul">
                    <li>
                      ...
                      <br /> 이를 통해 호이스팅, this 바인딩, 클로저 개념을 깊이
                      있게 습득
                    </li>
                    <li>
            ...
            <div className="text_box">
              <TextBlackHanSansContent>
                <div className="text_box">
                  <ul className="text_box_ul">
                    <li>
                      HTML, CSS, JavaScript, jQuery, React 등 프론트엔드 기술과
                      Java, MariaDB 등 백엔드 기초를 학습하며 <br /> 웹
                      애플리케이션의 전체 흐름을 이해
                    </li>
                    <li>실제로 코드를 작성하고 해석할 수 있는 역량 확보</li>
                  </ul>
                </div>
              </TextBlackHanSansContent>
            </div>
            ...
            <div className="text_box">
              <TextBlackHanSansContent>
                <div className="skill_block">
                  ...
                  <span className="skill_text another_skill_text">
