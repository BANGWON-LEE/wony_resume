                ...
                <div className="text_box">
                  <ul className="text_box_ul">
                    <li>
                      ...
                      보냄. 이를 해결하기 위해 MQTT 프로토콜을 도입하여 <br />
                      데이터 발생 시에만 실시간 수신하는 구조로 변경. 또한
                      ApexCharts를 활용하여 초기 렌더링과 데이터 갱신을 <br />
                      분리하여 최적화를 진행.
                    </li>
                    <li>
                ...
                <div className="text_box">
                  <ul className="text_box_ul">
                    <li>
                      ...
                      서비스 사용자 페이지(19개)와 관리자 페이지(5개) <br /> 총
                      24개 페이지에 대해 반응형 퍼블리싱을 단독으로 진행함.
                      관리자 페이지는 MUI 기본 컴포넌트를 활용하여 <br /> 빠르게
                      개발하고, 기본 레이아웃과 UI를 신속하게 구성함. 퍼블리싱
                      작업은 약 2개월 내에 완료하여 <br />
                      개발 일정 준수에 기여함.
                    </li>
                  </ul>
            ...
            <div className="text_box">
              ...
              <TextBlackHanSansContent>
                <div className="text_box">
                  <ul className="text_box_ul">
                    <li>
                      토토 판매점 위치 정보를 지도에 효과적으로 시각화하기 위해
                      Kakao Map API를 활용하여, API로 전달받은 토토 <br />
                      판매점 좌표만 필터링하여 마커로 시각화. 지도는 필요 시에만
                      동적 로딩되도록 설정하고, <br /> 이벤트 리스너를 통해 로딩
                      흐름 최적화.
                    </li>
                    <li>
